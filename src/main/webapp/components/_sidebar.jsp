            ...
            <c:choose>
                <c:when test="${sessionScope.user != null}">
                    <div class="header_img">
                        <c:choose>
                            <c:when test="${sessionScope.user.profileImageUrl == null}">
                ...
                <c:otherwise>
                    <a style="color: #00171F" href="${pageContext.request.contextPath}/register">Crie sua conta</a>
                </c:otherwise>
            </c:choose>
        </header>
        <div class="l-navbar show" id="nav-bar">
            <nav class="nav">
                <div>
                    ...
                    <c:if test="${sessionScope.user != null}">
                        <a href="${pageContext.request.contextPath}/post/meusPosts"
                           class="nav_link ${pageContext.request.servletPath == "/meusPosts.jsp" ? "active" : ""}">
                        ...
                        <a href="${pageContext.request.contextPath}/perfil/${sessionScope.user.username}"
                           class="nav_link">
                            <c:choose>
                                <c:when test="${sessionScope.user == null || sessionScope.user.profileImageUrl == null}">
                                    <img src="${pageContext.request.contextPath}/resources/default-profile.jpeg"
